            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-xl transition duration-300 ease-in-out hover:scale-105">
              ...
              <div class="p-5">
                <div class="flex items-center justify-between">
                  <div>
                    <span class="text-2xl font-bold text-gray-900 dark:text-white">{item.price}</span><span class="text-xl font-bold text-gray-900 dark:text-white"> tr/tháng</span>
                  </div>
                  <div>
    ...
    <>
...

      {
        ...
        <div className="w-2/4 text-center">
          ...
          <div className="uppercase font-bold border-l p-3">Diện tích</div>
          <div className="uppercase font-bold border-l p-3">Số phòng ngủ</div>
        ...
        <div className="w-2/4 text-center">
              ...
              <div className="uppercase border-custom p-3">{add[0].areas || 0}</div>
              <div className="uppercase border-custom p-3">{add[0].numberBed || 0}</div>
